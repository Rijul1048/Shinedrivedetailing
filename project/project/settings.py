...
# Email Configuration
EMAIL_HOST_USER = config('EMAIL_HOST', default='rijul.vishal.ahuja@gmail.com')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='')

# Use console backend for development if no email password is provided
if not EMAIL_HOST_PASSWORD:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    print("WARNING: No email password configured. Emails will be printed to console.")
else:
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='rijul.vishal.ahuja@gmail.com')